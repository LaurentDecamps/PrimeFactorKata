...
public class PrimeFactorTest
{
    ...
    [Test]
    public void Should_Return_Three_For_Input_Six()
    {
        var twoPrimeFactors = GetPrimeFactor(6);
        twoPrimeFactors.Should().BeEquivalentTo(GetArrayInitiateWith(2,3));
    }

    [Test]
    public void Should_Return_Three_For_Input_Seven()
    {
        var twoPrimeFactors = GetPrimeFactor(7);
        twoPrimeFactors.Should().BeEquivalentTo(GetArrayInitiateWith(7));
    }
